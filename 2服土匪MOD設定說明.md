...
| 參數 | Wave 1 (友善) | Wave 2 (敵對) | Wave 3 (友善) | Wave 4 (敵對) | Wave 5 (友善) | Wave 6 (敵對) | Wave 7 (友善) | Wave 8 (敵對) |
|------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|
| 啟用 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
| 友善 | 是 | 否 | 是 | 否 | 是 | 否 | 是 | 否 |
...
| 參數 | Wave 9 (友善) | Wave 10 (敵對) | Wave 11 (友善) | Wave 12 (敵對) | Wave 13 (友善) | Wave 14 (敵對) | Wave 15 (友善) | Wave 16 (敵對) |
|------|---------------|----------------|----------------|----------------|----------------|----------------|----------------|----------------|
| 啟用 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
| 友善 | 是 | 否 | 是 | 否 | 是 | 否 | 是 | 否 |
